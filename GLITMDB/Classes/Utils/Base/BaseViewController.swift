...
class BaseViewController: UIViewController {
    ...
    func setupHomeNavigation(title: String) {
        if #available(iOS 15, *) {
            ...
            appearance.backgroundColor = TMDBColor.tmdbDarkBlue.getColor()
        ...
        navigationController?.navigationBar.barTintColor = TMDBColor.tmdbLightBlue.getColor()
    ...
    func setupMovieDetailNavigation() {
        ...
        navigationController?.navigationBar.isTranslucent = false
        navigationController?.navigationBar.tintColor = .white
        navigationController?.navigationBar.barTintColor = TMDBColor.tmdbDarkBlue.getColor()
